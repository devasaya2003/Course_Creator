...
class CourseListMainTablet extends StatelessWidget {
  final int courseIndex;

  const CourseListMainTablet({super.key, required this.courseIndex});
        ...
        builder: (context, candidateData, rejectedData) => Container(
          ...
          child: value.modules[courseIndex].courseItems.isEmpty == false
              ? Column(
                  ...
                  children: [
                    ModuleNameWidgetTablet(courseIndex: courseIndex),
                    AllAttributesTablet(courseIndex: courseIndex),
                  ],
                )
